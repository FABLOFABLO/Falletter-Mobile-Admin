            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: outlinedButtonBuilder(
                        ...
                        onPressed: () => notifier.selectGender(Gender.male),
                      ),
                    ),
                    ...
                    Expanded(
                      child: outlinedButtonBuilder(
                        ...
                        onPressed: () => notifier.selectGender(Gender.female),
                      ),
                    ),
                  ],
                ),
              ...
              CustomTextFormField(
                ...
                decoration: decorationBuilder(
                  label: '이메일',
                  hint: '이메일을 입력해주세요.',
                  suffixIcon: FieldIcon.emailText(), // @dsm.hs.kr
                  showError: showError && state.emailLocalPart.trim().isEmpty,
                ),
              ),
              ...
              Align(
                ...
                child: SizedBox(
                  ...
                  child: OutlinedButton(
                    onPressed: () => notifier.sendVerifyCode(),
                    style: OutlinedButton.styleFrom(
                      side: const BorderSide(color: FalletterColor.gray500),
              ...
              CustomTextFormField(
                ...
                onFieldSubmitted: (_) =>
                    state.canGoNextInfo ? notifier.nextToPassword() : null,
                decoration: decorationBuilder(
                  label: '인증번호',
                  hint: '인증번호를 입력해주세요.',
                  suffixIcon: null,
                  showError: showError && state.verifyCode.trim().isEmpty,
                ),
              ),
            ],
          ),
